...
// This file and the "AudioPlayer.java" file is used to convert the text to speech.
// I have used the Mary TTS library for converting the text to speech. 
// You can check out the Mary TTS library here - http://mary.dfki.de/

// This code is written by GOXR3PLUS.
// I have taken the code from his Github repository - https://github.com/goxr3plus/Java-Text-To-Speech-Tutorial
// I just pass the sentence as a parameter to the speak function to convert the text to speech.
